...
public class C_T_Sys_Donematters {
    private String uuid;
    ...
    public Integer getIfSendMsg() {
        return ifSendMsg;
    }

    public void setIfSendMsg(Integer ifSendMsg) {
    ...
    public Integer getIsWtDoc() {
        return isWtDoc;
    }

    public void setIsWtDoc(Integer isWtDoc) {
        this.isWtDoc = isWtDoc;
    }
    ...
    public void setPriorities(String priorities) {
        this.priorities = priorities == null ? null : priorities.trim();
    }
