...
<html>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td width="10%" class="ziduan" style="text-align:center">
								<input type="button"  value="选择" onfocus="this.blur();" title="移动节点 右->左"
									onclick="moveTreeL2R();" />
                                <br/><br/><br/>
								<input type="button" value="删除" onfocus="this.blur();" title="移动节点 左->右"
									onclick="moveTreeR2L();" />
							</td>
							<td width="40%" valign="top">
								<div class="l_tree2 auto_tree" style="overflow: auto">
	...
	var setting = {
		...
		$.ajax( {
			...
			type : 'POST',
			dataType : "json",
			url : "common/UserSelect_detailsLoad_treegrid.action?userSelRa="+$("#userSelRa").val(),//???óμ?action?·??  
		...
		selectPeopleTree = $("#selectPeopleTree").zTree(setting, selectPeopleNode);
		//展开所有节点
