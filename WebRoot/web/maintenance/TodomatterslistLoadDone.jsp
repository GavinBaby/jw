...
<html>
	...
	<body class="easyui-layout">
		...
		<div data-options="region:'north',border:false"
			...
			<table width="100%" height="28" border="0" cellpadding="0"
				...
				<tr>
					<jtag:jlevel moduleId="module04010200"></jtag:jlevel>
				</tr>
			</table>
		</div>
	...
	$(function() {
		$('#list').datagrid( {
			url : 'Todomatters_gridLoadDone_grid.action',
			frozenColumns: null,
			columns : [ [
				{
				field : 'createTime',
		...
		$('#modttree').tree({
			animate:true,
			url : 'maintenanceajax/Todomatters_getModTree_treegrid.action?flag=1',
