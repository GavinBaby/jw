...
<html>
	...
	<body class="easyui-layout">
		...
		<div data-options="region:'north',border:false"
			...
			<table width="100%" height="28" border="0" cellpadding="0"
				...
				<tr>
					<jtag:jlevel moduleId="module04020100"></jtag:jlevel>
				</tr>
			</table>
		</div>
	...
	$(function() {
		$('#list').datagrid( {
			url : 'Todomatters_gridLoadLook_grid.action',
			columns : [ [
				{
				field : 'createTime',
				title : '日期',
		...
		$('#modttree').tree({
				animate:true,
				url : 'maintenanceajax/Todomatters_getModTree_treegrid.action?flag=03',
