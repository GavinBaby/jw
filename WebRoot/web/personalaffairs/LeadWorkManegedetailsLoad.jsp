...
.choose_biaodan td {
	...
	<body class="easyui-layout">
		<div data-options="region:'north',border:false"
			...
			<table width="100%" height="28" border="0" cellpadding="0"
				...
				<tr>
					<jtag:jlevel moduleId="module08010301"></jtag:jlevel>
				</tr>
			</table>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td width="12%" align="left">
										<jtag:jsl id="username" list="list_C_T_Sys_User" onchange="changdept();"
                                        name="username" listKey="uuid" listValue="userName" theme="simple"
    ...
    function changdept(){
        ...
        $.ajax( {
            ...
            type : 'POST',
            dataType : "json",
            url : "../personalaffairs/LeadWorkManege_leadworkmanagetree_treegrid.action",//请求的action路径  
    ...
    function updateData(){
    	...
    	var username = $("#username").val();
    	jQuery.ajax( {
            url : "LeadWorkManege_detailsUpdate_ajax.action",
            type : "POST",
            data :  {"seldeptsByUser":b+"","username":username},
            dataType : "json",
            error : function() {//请求失败处理函数  
