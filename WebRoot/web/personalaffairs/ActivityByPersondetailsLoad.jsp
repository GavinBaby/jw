								...
								.fullCalendar(
										{
											...
											eventClick : function(event,
					    					   ...
					    					   if (title) {
													...
													$.post("personalaffairs/ActivityByPerson_detailsDelete_ajax.action",{id : event.id},function() {});

													}       
												}
												if (title) {
													calendar.fullCalendar('updateEvent',event);
													$.post("personalaffairs/ActivityByPerson_detailsUpdate_ajax.action?actiontype=edit", {
														title :event.title,
											...
											select : function(start, end,allDay) {
												...
												if (title) {
													...
													$.post("personalaffairs/ActivityByPerson_detailsUpdate_ajax.action?actiontype=save", {
														title : title[0],
														plannig: title[1],
														start : start,
														end : end,
											...
											events : function(start, end,
												...
												$.ajax( {
														url : 'personalaffairs/ActivityByPerson_detailsLoadjax_ajax.action?id='+id,
														data : {		
