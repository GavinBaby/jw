						...
						<s:iterator value="list_B_V_Uft_Activity" id="activity"
							...
							<tr valign="top">
								...
								<td bgcolor="#FFFFFF">
									...
									<a href="javascript:void(0);" onclick="openNew('personalaffairs/ActivityByWeek_detailsLoad.action?startTime='+${time[0]}, '领导工作安排登记', 1000, 530, id);">
									<s:property
								...
								<td bgcolor="#FFFFFF">
									...
									<a href="javascript:void(0);" onclick="openNew('personalaffairs/ActivityByWeek_detailsLoad.action?startTime='+${time[1]}, '领导工作安排登记', 1000, 530, id);">
									<s:property
								...
								<td bgcolor="#FFFFFF">
									...
									<a href="javascript:void(0);" onclick="openNew('personalaffairs/ActivityByWeek_detailsLoad.action?startTime='+${time[2]}, '领导工作安排登记', 1000, 530, id);">
									<s:property
								...
								<td bgcolor="#FFFFFF">
									...
									<a href="javascript:void(0);" onclick="openNew('personalaffairs/ActivityByWeek_detailsLoad.action?startTime='+${time[3]}, '领导工作安排登记', 1000, 530, id);">
									<s:property
								...
								<td bgcolor="#FFFFFF">
									...
									<a href="javascript:void(0);" onclick="openNew('personalaffairs/ActivityByWeek_detailsLoad.action?startTime='+${time[4]}, '领导工作安排登记', 1000, 530, id);">
									<s:property
								...
								<td bgcolor="#FFFFFF">
									...
									<a href="javascript:void(0);" onclick="openNew('personalaffairs/ActivityByWeek_detailsLoad.action?startTime='+${time[5]}, '领导工作安排登记', 1000, 530, id);">
									<s:property
								...
								<td bgcolor="#FFFFFF">
									...
									<a href="javascript:void(0);" onclick="openNew('personalaffairs/ActivityByWeek_detailsLoad.action?startTime='+${time[6]}, '领导工作安排登记', 1000, 530, id);">
									<s:property
