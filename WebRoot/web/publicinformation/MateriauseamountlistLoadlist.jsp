...
<html>
	...
	<body class="easyui-layout">
		<div data-options="region:'north',border:false"
			...
			<table width="100%" height="28" border="0" cellpadding="0"
				...
				<tr>
					<jtag:jlevel moduleId="module11040200"></jtag:jlevel>
				</tr>
			</table>
				...
				<tr>
					<td>
						<s:form id="searchData" name="searchData"
							action="Materiauseamount_listLoadlist.action" theme="simple" method="post"
							cssClass="jNice">
	...
	$(function() {
		...
		$('#list').datagrid( {
			url : 'Materiauseamount_gridLoadlist_grid.action',
