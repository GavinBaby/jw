...
var pheight = 0;//lisy add 121121，输入控件高度
if(_196.pheight!=null){//lisy add 121121
	pheight = _196.pheight;//lisy add 121121
}//lisy add 121121

if(_196.dirction!=null){//lisy add 121121
	if (_196.dirction=="up")//lisy add 121121，dirction为panel弹出方向
		if (opts.top>_197.height()+pheight)//lisy add 121128，系统有时会根据控件位置自动调整向上向下
			opts.top=opts.top-_197.height()-pheight;//lisy add 121121，_197.height()为panel实际高度
	}//lisy add 121121
}
...
if(!tip){
//tip=$("<div class=\"validatebox-tip\">"+"<span class=\"validatebox-tip-content\">"+"</span>"+"<span class=\"validatebox-tip-pointer\">"+"</span>"+"</div>").appendTo("body");//lisy del 121122,提示框箭头向左
tip=$("<div class=\"validatebox-tip\">"+"<span class=\"validatebox-tip-content\">"+"</span>"+"<br/><span class=\"validatebox-tip-pointer\">"+"</span>"+"</div>").appendTo("body");//lisy add 121122,提示框箭头向下
...
if(tip){
//tip.css({display:"block",left:box.offset().left+box.outerWidth(),top:box.offset().top});//lisy del 121121 输入提示位置，在右
//tip.css({display:"block",left:box.offset().left,top:box.offset().top-tip.height()-18});//lisy add 121128,lisy del 121206
var tipwidth = box.width();//lisy add 130124
if (tipwidth<120) tipwidth = 120;//lisy add 130124
tip.css({display:"block",left:box.offset().left,top:box.offset().top-tip.height()-18,width:tipwidth});//lisy add 121206 输入提示位置，在上，tip.height()为提示信息高度，18为箭头预留高度,//lisy mod 130124
}
};
function _38a(_38f){
...
if(opts.required){
var isblank = false;//lisy add 121126
if(_393=="") isblank = true;//lisy add 121126
if (_393.indexOf("请选择")>=0) isblank = true;//lisy add 121126
//if(_393==""){//lisy del 121126
if(isblank){//lisy add 121126
...
_387(this);
var isrequired = $.data(this,"validatebox").options['required'];//lisy add 130129
var box=$(this);//lisy add 130129
if(box.val()=="" && isrequired==true)//lisy add 130129
{//lisy add 130129
	box.addClass("validatebox-invalid");//lisy add 130129
	$.data(this,"validatebox").message=$.fn.validatebox.defaults.missingMessage;//lisy add 130129
}//lisy add 130129
});
};
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns: [[{ field: 'deleteFlag', checkbox: true}]],columns:undefined,fit : true,fitColumns:true,border : false,autoRowHeight:true,toolbar:null,striped:true,method:"post",nowrap:false,idField:null,url:null,loadMsg:"数据加载中请稍后……",rownumbers:true,singleSelect:false,checkOnSelect : false,selectOnCheck : false,pagination:true,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_5e5,_5e6){
...
//_71c.panel("move",{left:_71b.offset().left,top:_71d()});//lisy del 121121
_71c.panel("move",{left:_71b.offset().left,top:_71d(),dirction:opts.dirction,pheight:_71b.height()});//lisy add 121121，增加弹出方向及输入控件高度
_71c.panel("open");
opts.onShowPanel.call(_71a);
(function(){
if(_71c.is(":visible")){
//_71c.panel("move",{left:_71e(),top:_71d()});//lisy del 121121
	_71c.panel("move",{left:_71e(),top:_71d(),dirction:opts.dirction,pheight:_71b.height()});//lisy add 121121，增加弹出方向及输入控件高度
setTimeout(arguments.callee,200);
}
})();
function _71e(){
...
var t=$(_74b);
//return $.extend({},$.fn.validatebox.parseOptions(_74b),$.parser.parseOptions(_74b,["width","separator",{panelWidth:"number",editable:"boolean",hasDownArrow:"boolean",delay:"number"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined),disabled:(t.attr("disabled")?true:undefined),value:(t.val()||undefined)});//lisy del 121121
return $.extend({},$.fn.validatebox.parseOptions(_74b),$.parser.parseOptions(_74b,["width","separator","dirction",{panelWidth:"number",editable:"boolean",hasDownArrow:"boolean",delay:"number"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined),disabled:(t.attr("disabled")?true:undefined),value:(t.val()||undefined)});//lisy add 121121
};
//$.fn.combo.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",panelWidth:null,panelHeight:200,multiple:false,separator:",",editable:true,disabled:false,hasDownArrow:true,value:"",delay:200,keyHandler:{up:function(){//lisy del 121121
$.fn.combo.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",panelWidth:null,panelHeight:200,multiple:false,separator:",",editable:true,disabled:false,dirction:"down",hasDownArrow:true,value:"",delay:200,keyHandler:{up:function(){//lisy add 121121
},down:function(){
},enter:function(){
},query:function(q){
